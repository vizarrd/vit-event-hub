...
import { Calendar, Loader2, Mail, Lock, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md relative animate-scale-in shadow-xl border-border/50">
        <CardHeader className="text-center pb-2">
          ...
          <CardDescription>Sign in to manage your club events</CardDescription>
        </CardHeader>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <CardFooter className="flex flex-col gap-4">
            ...
            <p className="text-sm text-muted-foreground text-center">
              Contact OSPC admin to get access credentials
            </p>
          </CardFooter>
        </form>
      </Card>
